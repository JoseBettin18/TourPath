    ...
    private void loadCities() {
        List<City> cities = List.of(
                City.builder().name("Cartagena").country("Colombia").countryCode("CO")
                        ...
                        .description(
                                "Ciudad amurallada Patrimonio de la Humanidad, con playas caribeñas y arquitectura colonial.")
                        ...
                        .tags(List.of("caribe", "colonial", "playas", "historia")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("París").country("Francia").countryCode("FR")
                        ...
                        .tags(List.of("arte", "gastronomia", "moda", "romantico")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("Tokio").country("Japón").countryCode("JP")
                        ...
                        .tags(List.of("tecnologia", "cultura", "gastronomia", "templos")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("Nueva York").country("Estados Unidos").countryCode("US")
                        ...
                        .tags(List.of("manhattan", "museos", "broadway", "rascacielos")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("Ciudad de México").country("México").countryCode("MX")
                        ...
                        .tags(List.of("historia", "gastronomia", "arte", "azteca")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("Buenos Aires").country("Argentina").countryCode("AR")
                        ...
                        .tags(List.of("tango", "gastronomia", "teatro", "cultura")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("Dubái").country("Emiratos Árabes Unidos").countryCode("AE")
                        ...
                        .tags(List.of("lujo", "rascacielos", "desierto", "compras")).createdAt(LocalDateTime.now())
                        .build(),
                ...
                City.builder().name("Roma").country("Italia").countryCode("IT")
                        ...
                        .tags(List.of("historia", "coliseo", "vaticano", "gastronomia")).createdAt(LocalDateTime.now())
                        .build(),
        ...
        cityRepository.findByNameIgnoreCase("Cartagena").ifPresent(cartagena -> {
            List<Place> places = List.of(
                    Place.builder().name("Ciudad Amurallada")
                            .description(
                                    "Patrimonio UNESCO. Murallas coloniales del siglo XVI, calles empedradas y arquitectura barroca que te transportan al pasado.")
                            ...
                            .tags(List.of("historia", "UNESCO", "colonial")).createdAt(LocalDateTime.now())
                            .updatedAt(LocalDateTime.now()).build(),

                    Place.builder().name("La Cevichería")
                            .description(
                                    "El restaurante de mariscos más famoso de Cartagena. Ceviches creativos con los mejores mariscos del Caribe colombiano.")
                            ...
                            .tags(List.of("mariscos", "ceviche", "gourmet")).createdAt(LocalDateTime.now())
                            .updatedAt(LocalDateTime.now()).build(),

                    Place.builder().name("Café del Mar")
                            .description(
                                    "Bar icónico sobre las murallas coloniales. El mejor lugar para ver el atardecer caribeño con un cóctel tropical.")
                            ...
                            .tags(List.of("cocktails", "atardecer", "murallas")).createdAt(LocalDateTime.now())
                            .updatedAt(LocalDateTime.now()).build());
        ...
        cityRepository.findByNameIgnoreCase("París").ifPresent(paris -> {
            List<Place> places = List.of(
                    Place.builder().name("Torre Eiffel")
                            .description(
                                    "El monumento más visitado del mundo. Vistas panorámicas espectaculares de París desde 330 metros de altura.")
                            .category(Place.Category.SITIO_TURISTICO)
                            ...
                            .tags(List.of("icónico", "vistas", "romántico")).createdAt(LocalDateTime.now())
                            .updatedAt(LocalDateTime.now()).build(),

                    Place.builder().name("Museo del Louvre")
                            .description(
                                    "El museo más grande del mundo con más de 35,000 obras incluyendo la Mona Lisa y la Venus de Milo.")
                            ...
                            .tags(List.of("arte", "historia", "monaLisa")).createdAt(LocalDateTime.now())
                            .updatedAt(LocalDateTime.now()).build());
            placeRepository.saveAll(new ArrayList<>(places));
        });
        ...
        cityRepository.findByNameIgnoreCase("Tokio").ifPresent(tokio -> {
            List<Place> places = List.of(
                    Place.builder().name("Templo Senso-ji")
                            .description(
                                    "El templo budista más antiguo de Tokio en el barrio de Asakusa. Arquitectura tradicional japonesa del siglo VII.")
                            .category(Place.Category.SITIO_TURISTICO)
                            ...
                            .tags(List.of("budismo", "historia", "cultura")).createdAt(LocalDateTime.now())
                            .updatedAt(LocalDateTime.now()).build());
            placeRepository.saveAll(new ArrayList<>(places));
        });
