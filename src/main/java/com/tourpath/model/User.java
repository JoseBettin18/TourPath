...
public class User {
    ...
    public static class Builder {
        ...
        public Builder ownedPlaceId(String v)          { this.ownedPlaceId = v; return this; }

        public User build() {
            User u = new User();
            u.id = id; u.username = username; u.email = email;
            u.password = password; u.fullName = fullName; u.phone = phone;
            u.roles = roles; u.enabled = enabled; u.accountNonLocked = accountNonLocked;
            u.createdAt = createdAt; u.updatedAt = updatedAt; u.ownedPlaceId = ownedPlaceId;
            return u;
        }
    }
    ...
    public String getOwnedPlaceId()               { return ownedPlaceId; }
    public void   setOwnedPlaceId(String v)       { this.ownedPlaceId = v; }
}
