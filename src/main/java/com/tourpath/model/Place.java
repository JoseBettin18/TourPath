...
public class Place {
    ...
    public static class Builder {
        ...
        public Builder cityId(String v)           { this.cityId = v; return this; }
        public Builder cityName(String v)         { this.cityName = v; return this; }
        ...
        public Builder bookingLabel(String v)     { this.bookingLabel = v; return this; }
        ...
        public Builder totalReviews(int v)        { this.totalReviews = v; return this; }
        ...
        public Place build() {
            ...
            p.category = category; p.cityId = cityId; p.cityName = cityName;
            p.countryName = countryName; p.address = address; p.phone = phone;
            p.website = website; p.email = email; p.bookingUrl = bookingUrl;
            p.bookingLabel = bookingLabel; p.latitude = latitude; p.longitude = longitude;
            p.mainImage = mainImage; p.images = images; p.averageRating = averageRating;
            p.totalReviews = totalReviews; p.featured = featured; p.active = active;
            p.openingHours = openingHours; p.priceRange = priceRange; p.tags = tags;
            p.ownerId = ownerId; p.ownerName = ownerName;
    ...
    public String getBookingLabel()              { return bookingLabel; }
    public void   setBookingLabel(String v)      { this.bookingLabel = v; }
