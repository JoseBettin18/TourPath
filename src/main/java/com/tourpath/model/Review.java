...
public class Review {
    ...
    public static class Builder {
        ...
        public Builder placeId(String v)             { this.placeId = v; return this; }
        ...
        public Review build() {
            Review r = new Review();
            r.id = id; r.placeId = placeId; r.userId = userId;
            r.username = username; r.comment = comment; r.rating = rating;
            r.active = active; r.createdAt = createdAt;
            return r;
        }
    }
